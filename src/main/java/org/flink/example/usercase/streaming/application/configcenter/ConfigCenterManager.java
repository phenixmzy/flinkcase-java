...
public class ConfigCenterManager {
    ...
    public static void init() {
        CONFIG_VALUES.put("canal.chuangliang_ad.test_u_user", "canal.chuangliang_ad.test_u_user.table,canal.chuangliang_ad.test_u_user.fields,canal.chuangliang_ad.test_u_user.kafka.sink.topic");
        CONFIG_VALUES.put("canal.chuangliang_ad.test_u_user.table", "test_u_user");
        CONFIG_VALUES.put("canal.chuangliang_ad.test_u_user.fields", "uid, u_name");
        CONFIG_VALUES.put("canal.chuangliang_ad.test_u_user.kafka.sink.topic", "test_u_user-sink");
        ...
        CONFIG_VALUES.put("canal.chuangliang_ad.toutiao_convert_info.kafka.sink.topic", "toutiao_convert_info-sink");
